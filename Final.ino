...
void loop() {
 ...
 // Wait a few seconds between measurements.
  ...
  if (!client.connected() && (millis() - lastConnectionTime > updateThingSpeakInterval)) {
    if(val_fire == HIGH){
      updateThingSpeak("field1=" +String(t)+"&field2="+String(h)+"&field3="+1);
     }
     else{
      updateThingSpeak("field1=" +String(t)+"&field2="+String(h)+"&field3="+0);
     }
  }
  Serial.println(300);
...
int t = 0;
    ...
    else
    {
      ...
      char c = 0 ;
        ...
        Serial.println("The current value is : ");
        Serial.print(c);
        Serial.println("The current value is : ");
        if(c == '1')
          {
            Serial.print(100);
            //mystepper.moveTo(50);
             mystepper.moveTo(mystepper.currentPosition()+10);
